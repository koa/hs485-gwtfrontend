...
public class FrontendComposite extends Composite {
  ...
  public FrontendComposite() {
    ...
    floorComposite.setWidth("100%");
    floorComposite.setHeight("100%");

    floorComposite.addFloorEventHandler(new FloorEventHandler() {
      @Override
      public void onInputDeviceClick(final ClickEvent event,
                                     final InputDevice inputDevice,
                                     final float scale,
                                     final Runnable iconUpdater) {
        // TODO Auto-generated method stub

      }

      @Override
      public void onInputDeviceMouseDown(final MouseDownEvent event,
                                         final InputDevice inputDevice,
                                         final float scale,
                                         final Runnable iconUpdater) {
        // TODO Auto-generated method stub
      ...
      @Override
      public void onOutputDeviceClick(final ClickEvent event,
      ...
      @Override
      public void onOutputDeviceMouseDown(final MouseDownEvent event,
                                          final OutputDevice outputDevice,
                                          final float scale,
                                          final Runnable iconUpdater) {
        // TODO Auto-generated method stub
